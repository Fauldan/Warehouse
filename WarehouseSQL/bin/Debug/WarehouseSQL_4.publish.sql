...
GO
PRINT N'Création de [dbo].[FK_Categorie_Article]...';


GO
ALTER TABLE [dbo].[Article]
    ADD CONSTRAINT [FK_Categorie_Article] FOREIGN KEY ([CategorieId]) REFERENCES [dbo].[Categorie] ([CategorieId]);
...
END
GO
PRINT N'Création de [dbo].[ArticleFull]...';
...
End
GO
PRINT N'Création de [dbo].[ArticleFull_By_Id]...';
